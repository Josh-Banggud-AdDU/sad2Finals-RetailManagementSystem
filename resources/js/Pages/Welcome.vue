...
<template>
    ...
    <div
        class="relative flex flex-col sm:flex sm:justify-center sm:items-center min-h-screen bg-center bg-savoy-blue"
    >
        ...
        <div v-if="canLogin" class="p-6 text-center">
            ...
            <template v-else class="flex flex-col space-x-4">
                <Link
                    :href="route('login')"
                ...
                <!--<Link
                    v-if="canRegister"
                    :href="route('register')"
                    class="m-4 px-6 py-2 text-white bg-savoy-blue border-4 border-ghost-white text-3xl font-bold font-montserrat rounded-md focus:outline-none hover:bg-ghost-white hover:text-savoy-blue transition-all duration-300 ease-in-out"
                    >Register</Link
                >
                -->
            </template>
...
export default {
    data() {
        return {
            imagePath: '/images/TJ GEAR MARKETING.png', // Adjust the image path accordingly
        };
    },
};
</script>
