        ...
        <div class="w-full">
            <div class="mx-auto rounded-lg overflow-hidden bg-ghost-white">
                <div class="bg-persian-red text-white p-4">
                    <h2 class="text-2xl font-bold font-montserrat text-center">Incomplete Entry Detected</h2>
                </div>
                <div class="flex p-3 px-8 pt-4 pb-6 flex-col figtree">
                    <div class="mb-2 text-lg font-montserrat text-justify leading-6">
                        Please fill up the remaining input fields.
                    </div>
                    <div class="flex justify-center space-x-6 items-center pt-3">
                        <button type="button" @click="closeModal" class="btn border border-persian-red bg-persian-red text-white font-bold rounded-md font-montserrat px-6 py-2 hover:bg-light-coral hover:border-light-coral transition-all duration-300 ease-in-out">
                            OK
                        </button>
                    </div>
                </div>
